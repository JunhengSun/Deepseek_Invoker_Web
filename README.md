...
* `/`
    * <img src="resources/1.png" style="zoom:30%;" />

* `/register`
    * <img src="resources/2.png" style="zoom:30%;" />

* `/login`
    * <img src="resources/3.png" style="zoom:30%;" />

* `/chat`
    * <img src="resources/5.png" style="zoom:30%;" />

* `/chat/create`
    * <img src="resources/6.png" style="zoom:30%;" />

* `/chat/<int:session_id>`
    * <img src="resources/7.png" style="zoom:30%;" />

* `/chat/history`
    * <img src="resources/8.png" style="zoom:30%;" />
    * After clicking to expand the details: <img src="resources/9.png" style="zoom:30%;" />